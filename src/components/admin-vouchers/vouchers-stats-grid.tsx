...
interface VouchersStatsGridProps {
  activeVouchersCount: number;
  onOpenAdd: () => void;
}

export const VouchersStatsGrid: React.FC<VouchersStatsGridProps> = memo(({
  activeVouchersCount,
  onOpenAdd,
}) => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between hover:shadow-md transition-all">
          ...
          <div>
            ...
            <h3 className="font-extrabold text-2xl text-slate-800 dark:text-white mt-1">{activeVouchersCount}</h3>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between hover:shadow-md transition-all">
          <div className="flex items-center justify-between mb-4">
            <div className="p-2.5 bg-emerald-550/10 dark:bg-emerald-950/40 rounded-lg text-emerald-500">
...
VouchersStatsGrid.displayName = "VouchersStatsGrid";
